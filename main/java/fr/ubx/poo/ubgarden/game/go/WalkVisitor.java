...
public interface WalkVisitor {
    ...
    /**
     * Determines whether the visitor can walk on the given {@link Flowers}.
     *
     * @param flowers the flower to evaluate
     * @return true if the visitor can walk on the flower, false by default
     */
    default boolean canWalkOn(Flowers flowers) { return false; }
}