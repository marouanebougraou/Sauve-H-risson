...
public final class SpriteFactory {
    ...
    public static Sprite create(Pane layer, GameObject gameObject) {
        ...
        if (gameObject instanceof Wasp) {
            return new SpriteInsect(layer, (Wasp) gameObject, ImageResource.WASP_DOWN,
                    ImageResource.WASP_LEFT, ImageResource.WASP_UP, ImageResource.WASP_RIGHT);
        }
        if (gameObject instanceof Hornet) {
            return new SpriteInsect(layer, (Hornet) gameObject, ImageResource.HORNET_DOWN,
                    ImageResource.HORNET_LEFT, ImageResource.HORNET_UP, ImageResource.HORNET_RIGHT);
        }
